...
public class SortStudentByGPA {
    ...
    public static Student[] set_array(int length){
        ...
        for (int i = 0; i < length; i++){
            System.out.println("Введите через enter, имя, фамилиюю, специальность, группу, курс, баллы: ");
            String name = sc.next();
    ...
    public static Student findStudentByName(Student[] arr, String targetName) throws StudentNotFoundException {
        for (Student s : arr) {
        ...
        while (n != 0){
            ...
            switch (n){
                ...
                case 5:
                    ...
                    System.out.println("Введите номер списка для поиска: ");
                    int listNum = sc.nextInt();
                    System.out.println(findStudentByName(iDNumber.get(listNum), tmpName));
            }
        }
